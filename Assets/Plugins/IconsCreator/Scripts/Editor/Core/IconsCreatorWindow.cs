...
namespace IconsCreationTool.Editor.Core
{
    public class IconsCreatorWindow : EditorWindow
    {
        ...
        private SerializedProperty _rotationSerializedProperty;
        private SerializedProperty _positionSerializedProperty;
        ...
        private void OnEnable()
        {
            ...
            if (!settingsProfile)
            {
                ...
                newSettingsProfile.SetValues(IconBackground.None, Color.white, null, null, string.Empty, "_Icon", 512,
                    0.1f, new Vector3(45f, -45f, 0f), Vector3.zero, false);
        ...
        private void SetupSerializedProperties()
        {
            ...
            _rotationSerializedProperty = _serializedObject.FindProperty(nameof(rotation));
            _positionSerializedProperty = _serializedObject.FindProperty(nameof(position));
        ...
        private void DrawSettingsProfileOptions()
        {
            ...
            if (GUILayout.Button("Save as"))
            {
                ...
                IconsCreatorSettingsProfile newSettingsProfile = CreateInstance<IconsCreatorSettingsProfile>();
                newSettingsProfile.SetValues(backgroundType, backgroundColor, backgroundTexture, frameTexture, prefix, suffix, size, padding, rotation, position, renderShadows);
        ...
        private void ApplySettingsProfile(IconsCreatorSettingsProfile settingsProfile)
        {
            ...
            _rotationSerializedProperty.vector3Value = settingsProfile.Rotation;
            _positionSerializedProperty.vector3Value = settingsProfile.Position;
        ...
        private void DrawOtherOptions()
        {
            using (IconsCreatorWindowElements.VerticalScope)
            {
                ...
                EditorGUILayout.PropertyField(_rotationSerializedProperty);

                IconsCreatorWindowElements.DrawSmallSpace();
                
                EditorGUILayout.PropertyField(_positionSerializedProperty);
        ...
        private void UpdateIconsCreator()
        {
            ...
            IconsCreatorData data =
                new IconsCreatorData(size, padding, prefix, suffix, backgroundData, frameTexture, targets, renderShadows, rotation, position);
