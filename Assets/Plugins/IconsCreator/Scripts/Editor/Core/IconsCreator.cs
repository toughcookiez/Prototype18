...
namespace IconsCreationTool.Editor.Core
{
    public class IconsCreator
    {
        ...
        public void SetData(IconsCreatorData data)
        {
            ...
            _iconsCreatorCamera.SetData(_data.Targets.FirstOrDefault(), _data.Size, _data.Padding, _data.Rotation, _data.Position);
        ...
        {
            _iconsCreatorCamera.SetData(target, _data.Size, _data.Padding, _data.Rotation, _data.Position);
