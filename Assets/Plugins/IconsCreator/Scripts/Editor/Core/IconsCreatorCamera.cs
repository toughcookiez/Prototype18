...
namespace IconsCreationTool.Editor.Core
{
    public class IconsCreatorCamera
    {
        ...
        private Vector3 _cameraRotation = new Vector3(45f, -45f, 0f);
        ...
        public void SetData(GameObject targetObject, int size, float padding, Vector3 rotation, Vector3 position)
        {
            if (size < 1)
            {
        ...
        private void SetPosition()
        {
            ...
            Vector3 targetCenter = _targetOrthographicBounds.center + _targetPosition;
